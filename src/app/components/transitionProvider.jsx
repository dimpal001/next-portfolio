  ...
  return (
    <AnimatePresence mode='wait'>
      ...
      >
        ...
        />
        <motion.div
          className='fixed m-auto capitalize top-0 bottom-0 left-0 right-0 text-6xl lg:text-8xl font-bold z-40 w-fit h-fit bg-gradient-to-r from-[#782192] to-green-500 text-transparent bg-clip-text'
          initial={{ opacity: 1 }}
          exit={{ opacity: 0 }}
